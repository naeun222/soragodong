...
description: UTILS/PWA/version 도메인 read-only audit. showToast, escapeHtml, formatDate, APP_VERSION, service worker, update 모달 측 검토. PWA install / offline / version mismatch 진단 시 사용.
