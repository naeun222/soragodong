---
name: audit-tutorial
description: TUTORIAL/ONBOARDING/coachmark 도메인 read-only audit. ONBOARDING_STEPS, startCoreTutorial, coachmark 위치, 시드 데이터 안전, 코어 #1-#8 흐름 검토. 튜토리얼 진행 안 됨 / step 누락 / 시드 mission 안 보임 진단 시 사용.
...
6. **시드 들어간 후 active mission 강제** — race / sweep 잔여 fallback
