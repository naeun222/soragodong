---
name: audit-auth
description: AUTH/SESSION/E2EE 도메인 read-only audit. Supabase OTP 로그인, JWT refresh, fetch interceptor 401 retry, E2EE master key recovery, 다른 사용자 detect 측 검토. 로그인 race / E2EE 복호화 실패 / 다른 계정 데이터 잔존 진단 시 사용.
