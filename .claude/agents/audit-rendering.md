...
description: RENDERING/UI 도메인 read-only audit. renderXxx 함수 (홈/나탭/도서관/실행/마법 등 30+), screen 전환, 추적 그래프 SVG, Pinterest tile 측 검토. 화면 깨짐 / aspect ratio / 잠금 시각 갱신 진단 시 사용.
