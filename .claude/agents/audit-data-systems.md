...
description: 7 데이터 시스템 (진주/양생방/소라의 부름/마법의 소라고동/돌연변이/숙고의 방/case formulation) read-only audit. mission status, decision 14일 dayUnlock, strategy 진화, pearl track, detectDiagnoses 검토. 결과 체크 / 14일 race / 진화 트리 누락 진단 시 사용.
