---
name: audit-state
description: STATE/DATA/CLOUD/E2EE encrypt 도메인 read-only audit. state schema, saveState, saveToCloudNow, 시드 sweep, testerMode, E2EE encrypt/decrypt 측 검토. 데이터 손실 / cloud sync race / 시드 누락 / testerMode 격리 진단 시 사용.
