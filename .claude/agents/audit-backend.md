---
name: audit-backend
description: Cloudflare Pages Functions backend 전체 read-only audit. auth/billing/chat/usage/feedback/admin/account endpoint 검토. RLS / verifyAuth / service_role 권한 / rate limit / Anthropic 프록시 진단 시 사용.
...
3. **ADMIN_USER_ID 검증** — admin endpoint 5개 모두
...
10. **idempotency 측면** — 모든 += / -= 에 atomic helper 사용
