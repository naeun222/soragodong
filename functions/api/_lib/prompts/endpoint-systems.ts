...
- 이번 챕터 *1회 발현* 신호는 new_traits / new_values / new_patterns 에 넣지 X.
  → 1회성이면 case_formulation_update.new_growth 또는 new_strength 로만.
- new_trait / pattern 은 *이 사용자의 다른 상황에서도 재발현할 거라 확신* 들 때만.
- 새 항목 만들기 전 자문: "이게 1회 사건인가, 반복 가능 신호인가?"
