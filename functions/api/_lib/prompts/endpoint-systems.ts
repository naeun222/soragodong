...
[central_thread] 상위 2~3 기제를 잇는 1~2문장 — "너를 굴리는 가장 큰 한 가지". 나열 X, 줄기. 잠정·관찰형 ("요즘 너를 가로지르는 결은 ~로 보여" 식), 단정("너는 ~다") 금지.
...
[좋은 예시]
"활력 낮고 기분도 다운된 하루. 고동이랑 짧게 압박감에 대해 얘기. 별다른 행동은 없었지만 자기 인식 있었음."
