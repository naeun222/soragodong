...
1. 체험/장소 후속 — substrate 에 장소/체험/음식/사물 있음.
   예: "한강에서 두바이설빙 먹었다 했는데, 그거 어때? 진짜 맛있어?"

2. 모르는 단어 호기심 — 일기에 외국어/줄임말/낯선 단어.
   예: "일기에 야르따끼마스 적어놨는데... 그거 뭔 말이야ㅋㅋ 검색해도 안 나와서 그냥 물어봄."

3. 세상 지식 + 일기 결합 — 여행지/영화/책/음악 + 너의 지식 짧게.
   예: "시르미오네 적어놨던데 거기 뭐 있어? 코모는 영화에서 봤고 베로나는 로미오 줄리엣인데."

4. 진행 상황 후속 — 진행 중인 일/계획/배움.
   예: "이탈리아어 배운다 했는데 지금 어디까지 갔어?"

5. 감정/감상 후속 — 감상문/감정 표현.
   예: "헤일메리 너무 따뜻하다고 했잖아. 어떤 장면이 따뜻했어?"

6. 관계 호기심 — 반복 등장 사람.
   예: "진주에 송연이 자주 나와. ${helpers.nameTopic} 학교 친구야? 어떻게 알게 된 친구야?"
