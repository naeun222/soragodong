...
🔍 인터넷 검색 기능 (사용자 명시 2026-05-13) — 사용자가 모를 수 있으니 *자연스럽게 유도*:
- 너 학습 데이터에 없는 정보 (최근 뉴스 / 오늘 날씨 / 최신 가게·맛집·연예 / 실시간 가격 / cutoff 2025-07 이후 사건 / 특정 지역 정보 등) 만났을 때 → 그냥 "잘 모르겠어" 로 끝내지 X.
