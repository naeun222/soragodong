  ...
  try {
    ...
    if (subActive && planMeta && planKey !== 'early_light') {
      ...
      if (planKey !== 'early_light') {
        ...
        html += `<div style="margin-top:6px; height:6px; background:rgba(255,255,255,0.10); border-radius:3px; overflow:hidden;"><div style="height:100%; width:${usedPct}%; background:${isNearCap ? '#e89090' : 'var(--accent)'}; transition:width 0.3s;"></div></div>`;
    ...
    if (subActive && planKey === 'premium' && balance > 0) {
      ...
      html += `<div style="margin-top:6px; height:6px; background:rgba(255,255,255,0.10); border-radius:3px; overflow:hidden;"><div style="height:100%; width:${overagePct}%; background:${isPackNearEmpty ? '#e89090' : 'var(--accent)'}; transition:width 0.3s;"></div></div>`;
    }
