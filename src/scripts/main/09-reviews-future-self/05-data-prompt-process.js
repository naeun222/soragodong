...
[출력 JSON]
{
  ...
  "strengths": ["이번 주 잘한 작은 win 3-5개 (구체, 자기 친밀 톤). 결과 X 시도·태도·관찰 ○.", "...", "..."],
...
[출력 JSON]
{
  ...
  "quotes": ["사용자 entries / 대화에서 추출한 짧은 인용 5개 (각 30자 이내, 5개)", "...", "...", "...", "..."],
  "strengths": ["이번 달 사용자가 잘한 작은 win 3-5개 (구체, 자기 친밀 톤, 자존감 boost). 결과 X 시도·태도·관찰 ○. 예: '월요일 마감 임박에도 잠 7시간 챙김', '엄마 통화 후 5분 산책으로 회복'", "...", "..."],
  "cycles": {
