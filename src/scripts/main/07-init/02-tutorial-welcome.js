...
const _LEGACY_ONBOARDING_STEPS = [
  ...
  // === Phase 7: 나 + 마무리 ===
  // 사용자 명시 2026-05-16 ultrathink: 실행 탭 폐기 — go_execute / exec_overview / exec_brain_dump_btn / exec_brain_dump_submit / exec_cards_intro / exec_drawer_intro / exec_timetable / exec_immerse_btn / exec_iphone_shortcut / exec_immerse_return / exec_immerse_done step 통째 제거.
  {
    id: 'go_model_final',
