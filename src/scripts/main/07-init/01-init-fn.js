...
async function init() {
  ...
  // V4 (사용자 명시 2026-05-25 ultrathink): 옛 inline diary 자동 요약 (init 7초 trigger) 재폐기.
  //   c612f5c 의 chat-batch.ts backend 합성 + _endpoint strip fix 후 batch path 정상 작동 확인 (cleanup batch submitted ✓).
