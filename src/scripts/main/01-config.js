...
// PORTONE_STORE_ID — PortOne 콘솔 → 상점 정보 → Store ID. 형식: 'store-XXXXXXXX-XXXX-...'.
const PORTONE_CHANNEL_KEY = 'channel-key-19a298fa-d855-4e4e-9eae-42d60448848e';
const PORTONE_STORE_ID = 'MOI0852178';  // 사용자 명시 2026-05-06. 형식 확인 필요 (PortOne V2 일반 형식 = 'store-UUID')
