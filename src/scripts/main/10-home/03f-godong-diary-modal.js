...
function _gdiaryRenderShell(opts) {
  ...
  // 부끄러운 고동 SVG (HANDOFF prototype VariantC.jsx L117-138 그대로).
  const shyGodongSvg = `
    <svg class="gdiary-shy-svg" width="72" height="64" viewBox="0 0 72 64" fill="none" aria-hidden="true">
      <path d="M 4 48 Q 36 42 68 48" stroke="rgba(201,169,110,0.45)" stroke-width="1.2" stroke-linecap="round"/>
      <path d="M 22 42 C 20 32, 26 22, 36 22 C 46 22, 52 30, 52 40 C 52 44, 50 46, 48 47 L 24 47 C 22 47, 22 44, 22 42 Z" fill="var(--accent)" opacity="0.92"/>
      <path d="M 32 38 Q 36 30 42 36 Q 38 40 34 38" stroke="rgba(15,14,23,0.35)" stroke-width="0.8" fill="none" stroke-linecap="round"/>
      <path d="M 30 36 Q 32 34.5 34 36" stroke="#0f0e17" stroke-width="1.2" stroke-linecap="round" fill="none"/>
      <path d="M 40 36 Q 42 34.5 44 36" stroke="#0f0e17" stroke-width="1.2" stroke-linecap="round" fill="none"/>
      <ellipse cx="27" cy="40" rx="3" ry="1.5" fill="#e8a4ad" opacity="0.55"/>
      <ellipse cx="47" cy="40" rx="3" ry="1.5" fill="#e8a4ad" opacity="0.55"/>
      <path d="M 18 18 L 16 14" stroke="var(--purple)" stroke-width="1.2" stroke-linecap="round"/>
      <path d="M 36 12 L 36 8" stroke="var(--purple)" stroke-width="1.2" stroke-linecap="round"/>
      <path d="M 54 18 L 56 14" stroke="var(--purple)" stroke-width="1.2" stroke-linecap="round"/>
    </svg>
  `;
