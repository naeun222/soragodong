...
function renderDecisionMiniLink() {
  ...
  container.innerHTML = `
    <div onclick="openMagicReflectionChooser()" class="decision-mini-card">
      <div class="dm-icon"><img src="/character/godong-wizard.png" alt="" class="godong-icon godong-mood-wizard" decoding="async"></div>
      <div class="dm-text">
    ...
    <div class="magic-chooser-card">
      ...
      <div class="magic-chooser-options">
        <button class="magic-chooser-opt" type="button" onclick="closeMagicChooser(); showScreen('decisions');">
          <div class="mco-icon"><img src="/character/godong-wizard.png" alt="" class="godong-icon godong-mood-wizard" decoding="async"></div>
          <div class="mco-text">
