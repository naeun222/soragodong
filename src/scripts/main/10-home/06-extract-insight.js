...
[name 필드 톤 — 사용자 명시 2026-05-09]
- 분석 보고서 톤 절대 X. 소라고동 친구 카톡 톤.
- 분석 문구 (예: "자기 친절 톤 정착", "환경 차원 도구 사용 늘어남", "거절 후 부채감 처리") X.
- 사용자 어휘 그대로 또는 짧은 친구 표현 (예: "자기한테 잘해줌", "환경 만지는 거 늘어남", "거절하면 미안함 며칠").
- 10자 내외, 길어도 15자. 형용사 절제. 진단명 / 분석 용어 X.
- description 은 길어도 OK (관찰 + 사용자 발화 인용). name 만 친구 톤 짧게.
