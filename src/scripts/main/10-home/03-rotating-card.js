...
❌ 또 안 되는 (사건 길고 느낌 짧음):
"오늘 ${_userName}이가 한강 갔다 왔다고 했다. 사진은 안 보냈고, 친구랑 갔다고 했다. 점심엔 김밥 먹었대. 좋았겠다."
→ 사건 3줄, 느낌 1줄. 비율 X.
...
→ 정확히 3편 일기. 3일 전 / 2일 전 / 어제 각각 1편.
  ...
  while (attempt < 4) {
    ...
    const _validParsedCount = parsed.filter(e => e && typeof e.body === 'string' && e.body.length >= 5).length;
