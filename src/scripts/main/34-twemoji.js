// V4 (사용자 명시 2026-05-18 ultrathink): Samsung 갤럭시에 Apple iPhone emoji 디자인 적용 (재).
//   사용자 명시 2026-05-18 최종: "갤럭시 이모티콘 아이폰 이모티콘으로 바꿔주고 크기는 지금처럼 똑같이 작게."
//   = Apple emoji 디자인 (emojicdn.elk.sh?style=apple) + 크기는 agent 1 의 0.9em 그대로.
//   Twemoji parser 인프라 활용 + image URL 만 emojicdn 으로 swap (callback).
